...
public class TestRuc {
	...
	public static void main(String[] args) {
		...
		// Login.setUsuario("10447915125");
		// Login.setPassword("985511933");
		// Login.setDocumento("RUC");
		// Login.setNro_documento("10447915125");
		// gson = new Gson();

		String Usuario = "10447915125";
		String Password = "xxxxx";
		String Documento = "RUC";
		String Nro_documento = "20538240134"; // 10447915125 20538240134
		try {
