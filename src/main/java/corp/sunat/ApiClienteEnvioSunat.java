...
public class ApiClienteEnvioSunat
{
    ...
    throws Exception
  {
    ...
    logger.debug("Request XML: " + new String(outputStream.toByteArray()));
    ...
    throws Exception
  {
	...
	public static String ConexionCPEStatusCDR(String ruc, String usuarioSol, String passSol, String tipoDocumento,
			String nro_comprobante, String nombreCPE, String nombreCDR, String rutaArchivo, String rutaWS) {
    ...
    throws Exception
  {
    ...
    logger.debug("Response XML: " + new String(outputStream.toByteArray()));
  }
    ...
    throws SAXException, IOException, ParserConfigurationException
  {
    ...
    try
    {
      ...
      String filePath = rutaArchivo + ".XML";
      File file = new File(filePath);
      if (!file.exists()) {
    	  filePath = rutaArchivo + ".xml";
      } 
      
      Document doc = dbf.newDocumentBuilder().parse(new FileInputStream(filePath), "ISO-8859-1");
